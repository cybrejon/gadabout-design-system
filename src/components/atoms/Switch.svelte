...
<div class="group inline-flex cursor-pointer flex-nowrap items-center gap-2">
	...
	>
		<Switch.Thumb
			class="pointer-events-none block h-3.5 w-3.5 rounded-full bg-white ring-0 transition-transform data-[state=checked]:translate-x-3.5 data-[state=unchecked]:translate-x-0"
		/>
	</Switch.Root>
	{#if labelText}
		<Label.Root
